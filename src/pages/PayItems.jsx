...
import AddPayItem from "../components/AddPayItem.jsx";
      ...
      <div className="md:ml-64 flex flex-col">
        ...
        <div className="m-2 p-3 border-2 border-gray-200 border-solid rounded-lg flex flex-row mx-10">
          <div className="overflow-x-auto">
            <table className="table table-3xl">
              <thead>
                <tr>
                  <th>
                    <label>
                  ...
                  <th>Pay Item</th>
                  <th>Pay Item Category</th>
                  <th>Unit Hour|Day|Month</th>
                  <th>Visible</th>
                  <th>Details</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>Holiday Pay (All Souls Day)</td>
                  <td>Wages</td>
                  <td>Day</td>
                  <td>
                    <svg
